<?php
	...
	while($stmt->fetch()){
		...
		//<p> kommentaar, hinne päevale: 6, lisatud kuupäev</p>
...
<img src="https://greeny.cs.tlu.ee/~rinde/vp_2022/vp_banner_gs.png">
	<meta charset="utf-8">
	<title> Jan Henrik Levertand programmeerib veebi</title>
</head>
<body>
...
<p> Mul on haigelt lahe toyota corolla mille kytusetoru lekib</p>  
</body>
</html>